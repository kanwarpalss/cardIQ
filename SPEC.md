...
| IKEA PDF-only item extraction | ✅ RESOLVED | PDF fallback is deployed; historical backfill applied. Live audit: 32/32 IKEA rows carry items (176 lines), 3 refunds correct, 14 duplicate invoice copies flagged. |
